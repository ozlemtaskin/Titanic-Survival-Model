...
df.loc[(df["NEW_AGE_CAT"]=="young") & (df["Sex"]=="female"),"NEW_SEX_CAT"]= "young female"
df.loc[(df["NEW_AGE_CAT"]=="young") & (df["Sex"]=="male"),"NEW_SEX_CAT"]= "young male"
df.loc[(df["NEW_AGE_CAT"]=="mature") & (df["Sex"]=="female"),"NEW_SEX_CAT"]= "mature female"
df.loc[(df["NEW_AGE_CAT"]=="mature") & (df["Sex"]=="male"),"NEW_SEX_CAT"]= "mature male"
df.loc[(df["NEW_AGE_CAT"]=="senior") & (df["Sex"]=="female"),"NEW_SEX_CAT"]= "senior female"
df.loc[(df["NEW_AGE_CAT"]=="senior") & (df["Sex"]=="male"),"NEW_SEX_CAT"]= "senior male"

#Family size
df["NEW_FAMSİZE_CAT"]= df["SibSp"]+ df["Parch"]
...
cat_cols = [col for col in cat_cols if col not in binary_cols and col not in ["Survived"]]
cat_cols
